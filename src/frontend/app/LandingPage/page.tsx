			...
			<div className="flex items-center mt-20 pl-20">
				<div className="flex-1 mr-10">
					<h1 className="text-5xl text-white font-black leading-[60px]">
						Optimal Hyperlink Search:{" "}
						<span className="text-[#7E5FFF]">BFS</span> and{" "}
						<span className="text-[#7E5FFF]">IDS</span> Techniques
					</h1>
					<p className="text-xl text-white mt-5 leading-8">
						Developed by a trio of university scholars, this tool employs
						advanced search algorithms, including Breadth-First Search (BFS) and
						Iterative Deepening Search (IDS), to efficiently determine the
						shortest hyperlink.
					</p>
