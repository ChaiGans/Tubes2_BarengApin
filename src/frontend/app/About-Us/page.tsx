...
const AboutUs = forwardRef<HTMLDivElement>((props, ref) => {
	...
	<div className="mt-20">
        ...
        <div className="flex justify-evenly ">
            ...
            <div
                className="Card1 group relative items-center justify-center overflow-hidden cursor-pointer rounded-[20px] mx-[50px] my-[30px] border-[#7E5FFF] border-[4px]"
            >
                ...
                ></div>
                <div
                className="absolute inset-[-30px] flex flex-col items-center justify-center px-9 text-center translate-y-[60%] group-hover:translate-y-0 transition-all font-Merriweather"
                >
                <h1 className="text-2xl font-bold text-[#7E5FFF]">Wilson Yusda</h1>
            ...
            <div
                className="Card2 rounded-[20px] group relative items-center justify-center overflow-hidden cursor-pointer mx-[50px] my-[30px] border-[#7E5FFF] border-[4px]"
            >
                <div className="h-[440px] w-64 relative ">
                <Image
                        src={son}
                ...
                ></div>
                <div
                className="absolute inset-[-20px] flex flex-col items-center justify-center px-9 text-center translate-y-[60%] group-hover:translate-y-0 transition-all font-Merriweather "
                >
                <h1 className="text-2xl font-bold text-[#7E5FFF]">Elbert Chailes</h1>
            ...
            <div
                className="Card3 rounded-[20px] group relative items-center justify-center overflow-hidden cursor-pointer  mx-[50px] my-[30px] border-[#7E5FFF] border-[4px]"
            >
                <div className="h-[440px] w-64 relative ">
                <Image
                        src={son}
